...
1. run `bin/remote-push-typo3-src`
...
All helper scripts in `bin/` (syncing content, deploying, cache flushing,
remote database access) are documented in [bin/README.md](bin/README.md).
